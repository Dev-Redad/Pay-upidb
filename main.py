...
# - One MongoDB handles everything: users, products, config, sessions, locks, (optional) payments log
# - UPI QR; no UPI link shown; caption short & professional; no buttons
# - Random price in a range (integers first; decimals only if needed)
# - Auto-delivery on payment message; window = 5m + 10s grace
...
PAYMENT_NOTIF_CHANNEL_ID = -1002865174188   # channel that receives "paid you ₹X" messages
...
# --- Admin: add product (file-first flow; supports "10" or "10-30") ---
